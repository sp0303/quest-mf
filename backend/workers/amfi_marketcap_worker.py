...
BASELINE_SECURITIES: list[tuple[str, str, str, str, str, int, float]] = [
    ...
    ("INE974X01010", "Tube Investments of India Ltd", "TIINDIA", "Automobile", "Auto Components", 115, 75000.0),
    ("INE372A01015", "Apar Industries Ltd", "APARINDS", "Capital Goods", "Heavy Electrical Equipment", 145, 38000.0),
    ("INE036D01028", "Karur Vysya Bank Ltd", "KVB", "Financial Services", "Private Commercial Banks", 210, 18000.0),
    ("INE745G01035", "Multi Commodity Exchange of India Ltd", "MCX", "Financial Services", "Other Financial Services", 175, 29000.0),
    ("INE010J01012", "Tejas Networks Ltd", "TEJASNET", "Telecommunication", "Telecom - Equipment", 190, 21000.0),
    ("INE117A01022", "ABB India Ltd", "ABB", "Capital Goods", "Heavy Electrical Equipment", 75, 165000.0),
    ("INE012A01025", "ACC Ltd", "ACC", "Construction Materials", "Cement & Cement Products", 125, 42000.0),
    ("INE437A01024", "Apollo Hospitals Enterprise Ltd", "APOLLOHOSP", "Healthcare", "Healthcare Services", 65, 95000.0),
    ("INE021A01026", "Asian Paints Ltd", "ASIANPAINT", "Consumer Durables", "Paints", 22, 280000.0),
    ("INE216A01030", "Bharat Electronics Ltd", "BEL", "Capital Goods", "Aerospace & Defense", 35, 220000.0),
    ("INE029A01011", "Bharat Petroleum Corp Ltd", "BPCL", "Energy", "Oil & Gas - Refining & Marketing", 45, 140000.0),
    ("INE059A01026", "Cipla Ltd", "CIPLA", "Healthcare", "Pharmaceuticals", 38, 125000.0),
    ("INE522F01014", "Coal India Ltd", "COALINDIA", "Metals & Mining", "Consumable Fuels", 25, 290000.0),
    ("INE361B01024", "Divis Laboratories Ltd", "DIVISLAB", "Healthcare", "Pharmaceuticals", 50, 140000.0),
    ("INE047A01021", "Grasim Industries Ltd", "GRASIM", "Construction Materials", "Cement & Cement Products", 48, 165000.0),
    ("INE860A01027", "HCL Technologies Ltd", "HCLTECH", "IT", "Computers - Software", 15, 480000.0),
    ("INE176B01034", "Havells India Ltd", "HAVELLS", "Consumer Durables", "Consumer Electronics", 60, 115000.0),
    ("INE585B01010", "Maruti Suzuki India Ltd", "MARUTI", "Automobile", "Automobiles - 4 Wheelers", 18, 380000.0),
    ("INE733E01010", "NTPC Ltd", "NTPC", "Power", "Power Generation", 14, 395000.0),
    ("INE213A01029", "Oil & Natural Gas Corp Ltd", "ONGC", "Energy", "Oil & Gas - Exploration & Production", 16, 370000.0),
    ...
    ("INE192A01025", "Tata Steel Ltd", "TATASTEEL", "Metals & Mining", "Ferrous Metals", 20, 210000.0),
    ("INE081A01020", "Tata Power Co Ltd", "TATAPOWER", "Power", "Integrated Power", 55, 135000.0),
    ("INE481G01011", "UltraTech Cement Ltd", "ULTRACEMCO", "Construction Materials", "Cement & Cement Products", 24, 320000.0),
    ("INE881D01027", "Persistent Systems Ltd", "PERSISTENT", "IT", "Computers - Software", 130, 85000.0),
    ("INE669E01016", "Vodafone Idea Ltd", "IDEA", "Telecommunication", "Telecom - Cellular", 108, 95000.0),
    ("INE721A01013", "Shriram Finance Ltd", "SHRIRAMFIN", "Financial Services", "NBFC", 40, 115000.0),
    ("INE089A01023", "Dr Reddys Laboratories Ltd", "DRREDDY", "Healthcare", "Pharmaceuticals", 36, 110000.0),
    ("INE152A01029", "Bajaj Auto Ltd", "BAJAJ-AUTO", "Automobile", "Automobiles - 2 & 3 Wheelers", 30, 280000.0),
    ("INE917I01012", "Bajaj Finserv Ltd", "BAJAJFINSV", "Financial Services", "Financial Institution", 32, 290000.0),
    ("INE296A01024", "Bajaj Finance Ltd", "BAJFINANCE", "Financial Services", "NBFC", 17, 440000.0),
    ("INE066A01021", "Bank of Baroda", "BANKBARODA", "Financial Services", "Public Commercial Banks", 52, 130000.0),
    ("INE528G01035", "Yes Bank Ltd", "YESBANK", "Financial Services", "Private Commercial Banks", 118, 68000.0),
    ("INE848E01016", "CG Power and Industrial Solutions", "CGPOWER", "Capital Goods", "Heavy Electrical Equipment", 85, 110000.0),
    ("INE067A01029", "Canara Bank", "CANBK", "Financial Services", "Public Commercial Banks", 80, 105000.0),
    ("INE205A01025", "Vedanta Ltd", "VEDL", "Metals & Mining", "Diversified Metals", 62, 185000.0),
    ("INE111A01025", "Indian Hotels Co Ltd", "INDHOTEL", "Consumer Services", "Hotels & Resorts", 95, 98000.0),
    ("INE160A01022", "Punjab National Bank", "PNB", "Financial Services", "Public Commercial Banks", 78, 120000.0),
    ("INE121A01024", "Cholamandalam Investment & Finance", "CHOLAFIN", "Financial Services", "NBFC", 82, 125000.0),
    ("INE028A01039", "Bank of India", "BANKINDIA", "Financial Services", "Public Commercial Banks", 140, 52000.0),
    ("INE271C01023", "DLF Ltd", "DLF", "Realty", "Real Estate Development", 58, 210000.0),
    ("INE257A01026", "Bharat Heavy Electricals Ltd", "BHEL", "Capital Goods", "Heavy Electrical Equipment", 90, 95000.0),
    ("INE134E01011", "Trent Ltd", "TRENT", "Consumer Services", "Retailing", 26, 260000.0),
    ("INE755601014", "Max Healthcare Institute Ltd", "MAXHEALTH", "Healthcare", "Healthcare Services", 92, 92000.0),
    ("INE326A01037", "Lupin Ltd", "LUPIN", "Healthcare", "Pharmaceuticals", 102, 94000.0),
    ("INE463A01028", "Torrent Pharmaceuticals Ltd", "TORNTPHARM", "Healthcare", "Pharmaceuticals", 88, 115000.0),
    ("INE503A01015", "Siemens Ltd", "SIEMENS", "Capital Goods", "Heavy Electrical Equipment", 44, 245000.0),
    ("INE019A01038", "JSW Steel Ltd", "JSWSTEEL", "Metals & Mining", "Ferrous Metals", 27, 230000.0),
    ("INE128A01029", "Sun Pharmaceutical Industries Ltd", "SUNPHARMA", "Healthcare", "Pharmaceuticals", 19, 410000.0),
    ("INE472A01039", "Blue Star Ltd", "BLUESTAR", "Consumer Durables", "Air Conditioners", 225, 34000.0),
    ...
    ("INE769A01020", "Aarti Industries Ltd", "AARTIIND", "Chemicals", "Specialty Chemicals", 272, 17800.0),
    ("INE944F01012", "Radico Khaitan Ltd", "RADICO", "Fast Moving Consumer Goods", "Breweries & Distilleries", 275, 24000.0),
    ("INE269A01021", "Sonata Software Ltd", "SONATSOFTW", "IT", "Computers - Software", 280, 16800.0),
    ("INE325A01013", "Timken India Ltd", "TIMKEN", "Capital Goods", "Bearing", 282, 28000.0),
    ("INE348B01021", "Century Plyboards India Ltd", "CENTURYPLY", "Consumer Durables", "Plywood Boards/Laminates", 285, 17500.0),
    ("INE120A01034", "Carborundum Universal Ltd", "CARBORUNIV", "Capital Goods", "Abrasives", 288, 25000.0),
    ("INE791I01019", "Brigade Enterprises Ltd", "BRIGADE", "Realty", "Real Estate Development", 290, 26000.0),
    ("INE220B01022", "Kalpataru Projects International", "KPIL", "Capital Goods", "Power Transmission & Distribution", 292, 19000.0),
    ("INE918Z01012", "Kaynes Technology India Ltd", "KAYNES", "Capital Goods", "Industrial Electronics", 295, 27000.0),
    ("INE018E01016", "Amber Enterprises India Ltd", "AMBER", "Consumer Durables", "Consumer Electronics", 298, 18000.0),
    ("INE970X01018", "Lemon Tree Hotels Ltd", "LEMONTREE", "Consumer Services", "Hotels & Resorts", 305, 11500.0),
    ("INE602A01023", "PCBL Ltd", "PCBL", "Chemicals", "Carbon Black", 308, 16000.0),
    ("INE495S01016", "Suven Pharmaceuticals Ltd", "SUVENPHAR", "Healthcare", "Pharmaceuticals", 312, 29000.0),
    ("INE618H01018", "Equitas Small Finance Bank Ltd", "EQUITASBNK", "Financial Services", "Small Finance Banks", 315, 10500.0),
    ("INE739E01017", "Cera Sanitaryware Ltd", "CERA", "Consumer Durables", "Ceramics", 320, 11000.0),
    ("INE146AA01010", "Kirloskar Oil Engines Ltd", "KIRLOSENG", "Capital Goods", "Engines", 322, 14000.0),
    ("INE00LO01017", "Craftsman Automation Ltd", "CRAFTSMAN", "Automobile", "Auto Components", 325, 12000.0),
    ("INE743C01021", "Quess Corp Ltd", "QUESS", "Consumer Services", "Commercial Services", 330, 9500.0),
    ("INE195J01029", "PNC Infratech Ltd", "PNCINFRA", "Capital Goods", "Civil Construction", 335, 10800.0),
    ("INE399C01030", "Suprajit Engineering Ltd", "SUPRAJIT", "Automobile", "Auto Components", 340, 6800.0),
    ("INE034A01011", "Arvind Ltd", "ARVIND", "Textiles", "Textiles - Denim", 345, 9200.0),
    ("INE634I01029", "KNR Constructions Ltd", "KNRCON", "Capital Goods", "Civil Construction", 350, 9600.0),
    ("INE418H01029", "Allcargo Logistics Ltd", "ALLCARGO", "Services", "Logistics", 355, 6200.0),
    ("INE949H01023", "Man Infraconstruction Ltd", "MANINFRA", "Realty", "Real Estate Development", 360, 7800.0),
    ("INE014W01014", "Aster DM Healthcare Ltd", "ASTERDM", "Healthcare", "Hospital Services", 255, 19800.0),
]
